"""Fetch Meteostat hourly data for Jan-Dec 2025 using RapidAPI and mirror to collect5.txt.
...
Usage:
  python fetch_meteostat_2025_rapidapi.py

Limits:
- RapidAPI free plan has request limits (500/month). This script makes 12 requests
  (one per month), which should be within limits.
"""
