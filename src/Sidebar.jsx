import { Bars3Icon, XMarkIcon, SunIcon, MoonIcon, ChartBarIcon, DevicePhoneMobileIcon, CloudIcon, WrenchScrewdriverIcon } from '@heroicons/react/24/outline'
...
export default function Sidebar({ activeTab, setActiveTab, isDark, setIsDark }) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`fixed inset-y-0 left-0 z-40 w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 shadow-lg transform ${
        isMobileOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'
      } transition-transform duration-300 ease-in-out md:relative md:translate-x-0`}>
        {/* Mobile toggle button */}
        <button 
          className="md:hidden absolute top-4 left-4 z-50 p-2 bg-white/90 dark:bg-gray-800/90 backdrop-blur-md rounded-lg shadow-lg border"
